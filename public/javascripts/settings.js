window.onload = function () {
    ...
    fetch("https://www.thesportsdb.com/api/v1/json/1/lookup_all_teams.php?id=4424").then(response => response.json())
        ...
        fetch("https://www.thesportsdb.com/api/v1/json/1/lookup_all_teams.php?id=4391").then(response => response.json())
        .then(function(data){
        ...
        fetch("https://www.thesportsdb.com/api/v1/json/1/lookup_all_teams.php?id=4387").then(response => response.json())
        .then(function(data){
        ...
        fetch("https://www.thesportsdb.com/api/v1/json/1/lookup_all_teams.php?id=4380").then(response => response.json())
        .then(function(data){
